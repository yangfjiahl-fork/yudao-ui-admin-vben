...
async function handleDeleteBatch() {
  ...
  try {
    await deleteItineraryList(checkedIds.value);
    checkedIds.value = [];
...
function handleRowCheckboxChange({
  ...
  records: GiftItineraryApi.Itinerary[];
}) {
...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<GiftItineraryApi.Itinerary>,
  gridEvents: {
