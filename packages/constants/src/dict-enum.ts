...
/** ========== Gift - 羔享模块 ========== */
const GIFT_DICT = {
  GIFT_AMAP_POI_TYPE: 'gift_amap_poi_type', // 高德 POI 类型
  GIFT_SLIDER_ITEM_JUMP_PAGE: 'gift_slider_item_jump_page', // 轮播图跳转页面
  ...
  GIFT_USER_FEEDBACK_CATEGORY: 'gift_user_feedback_category', // 用户反馈问题分类
